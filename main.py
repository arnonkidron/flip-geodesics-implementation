...
e2 = tri.flip_by(0, 2)
ee2 = (e2.origin, e2.dst)
triV2, triE2 = tri.get_polyline()
e3 = tri.flip_by(1, 0)
ee3 = (e3.origin, e3.dst)
...
vals_vert = np.random.rand(len(V))

init_polyscope()
ps.register_surface_mesh("Mesh", V, F).add_scalar_quantity("rand vals", vals_vert, defined_on='vertices')
